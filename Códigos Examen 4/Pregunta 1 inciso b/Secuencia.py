...
class Secuencia(ABC):
    ...
    @abstractmethod
    def remover(self):
        """Método abstracto remover (se implementará en la subclase que herede de Secuencia)"""
    
    @abstractmethod
    def vacio(self):
        """Método abstracto vacio (se implementará en la subclase que herede de Secuencia)"""
